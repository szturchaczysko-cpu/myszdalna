  ...
  "pozycje": [
    {
      ...
      "wartosc_netto": <wartość pozycji = ilość×cena, jeśli podana w osobnej kolumnie; inaczej null>,
    ...
    if nazwa_low.endswith(".pdf"):
        try:
            ...
            if ptp.czy_ma_warstwe_tekstowa(file_bytes):
                pozycje_txt, naglowek, blad_txt = ptp.parsuj_inter_cars(file_bytes)
